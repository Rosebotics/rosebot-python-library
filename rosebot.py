...
#             print("Left PWM: {}  Right PWM: {}  Left Speed: {}   Right Speed: {} ".format(adj_left,adj_right, self.speed_left,self.speed_right))
...
class RoseBotPid:
    ...
    def __init__(self, kp=0.4, ki=0.0, kd=0.0, integrator_max=100, integrator_min=-100, set_point=0.0):
