...
#TODO: Revert to the exact version from Alan's github repo
    ...
    def check_who_am_i(self):
        ...
        """
        register = self.RoseBotAccel_Register['WHO_AM_I']
    ...
    def standby(self):
        ...
        @return: No return value
        """
        register = self.RoseBotAccel_Register['CTRL_REG1']
        self.board.i2c_read_request(self.address, register, 1, Constants.I2C_READ | Constants.I2C_END_TX_MASK,
                                    self.data_val)
    ...
    def set_scale(self, scale):
        ...
        @return: No return value
        """
        register = self.RoseBotAccel_Register['XYZ_DATA_CFG']
        self.board.i2c_read_request(self.address, register, 1, Constants.I2C_READ | Constants.I2C_END_TX_MASK,
                                    self.data_val)
    ...
    def setup_portrait_landscape(self):
        ...
        @return: No return value
        """
        register = self.RoseBotAccel_Register['PL_CFG']
        ...
        register = self.RoseBotAccel_Register['PL_COUNT']
    ...
    def read_portrait_landscape(self):
        """
        This function reads the portrait/landscape status register of the RoseBotAccel.
        ...
        @return: See above.
        """
        register = self.RoseBotAccel_Register['PL_STATUS']
        self.board.i2c_read_request(self.address, register, 1, Constants.I2C_READ | Constants.I2C_END_TX_MASK,
                                    self.data_val)
    ...
    def setup_tap(self, x_ths, y_ths, z_ths):
        ...
        register = self.RoseBotAccel_Register['PULSE_CFG']
        ...
        register = self.RoseBotAccel_Register['PULSE_TMLT']
        ...
        register = self.RoseBotAccel_Register['PULSE_LTCY']
        ...
        register = self.RoseBotAccel_Register['PULSE_WIND']
        self.board.i2c_write_request(self.address, [register, 0xFF])  # 5. 318ms (max value) between taps max

    def read_tap(self):
        """
        This function returns any taps read by the RoseBotAccel. If the function
        ...
        """
        register = self.RoseBotAccel_Register['PULSE_SRC']
    ...
    def available(self):
        ...
        """
        register = self.RoseBotAccel_Register['STATUS']
        self.board.i2c_read_request(self.address, register, 1, Constants.I2C_READ | Constants.I2C_END_TX_MASK,
                                    self.data_val)
    ...
    def read(self):
        ...
        """
        register = self.RoseBotAccel_Register['OUT_X_MSB']
...
if __name__ == "__main__":
    ...
    accel = RoseBotAccel(board, 0x1d, 2, 0)
    while True:
        if accel.available():
            values = accel.read()
#             print(
